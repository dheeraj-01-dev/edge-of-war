...
//   return (
//     <div className={styles.terms} style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
...
//       <section>
//         <h2>User Accounts</h2>
//         <p>[Add content related to user accounts as outlined above]</p>
//       </section>

//       <section>
//         <h2>Use of the Website</h2>
//         <p>[Add content related to the acceptable use of the website]</p>
//       </section>

//       <section>
//         <h2>Tournaments and Competitions</h2>
//         <p>[Add content related to tournaments and competitions]</p>
//       </section>

//       <section>
//         <h2>Content Ownership and Intellectual Property</h2>
//         <p>[Add content related to intellectual property]</p>
//       </section>

//       <section>
//         <h2>Privacy</h2>
//         <p>[Add privacy-related content and link to the Privacy Policy]</p>
//       </section>

//       <section>
//         <h2>Limitation of Liability</h2>
//         <p>[Add content related to liability limitations]</p>
//       </section>

//       <section>
//         <h2>Indemnification</h2>
//         <p>[Add content related to user indemnification responsibilities]</p>
//       </section>

//       <section>
//         <h2>Modifications to Terms</h2>
//         <p>[Add content regarding the ability to modify the terms]</p>
//       </section>

//       <section>
//         <h2>Governing Law</h2>
//         <p>[Add content regarding the governing law]</p>
//       </section>
...
//       <section>
//         <h2>Miscellaneous</h2>
//         <p>[Add content related to severability and the entire agreement]</p>
//       </section>
//     </div>
//   );
// }
